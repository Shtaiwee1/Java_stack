        ...
        <div class="row justify-content-center">
            ...
            <h3>Register</h3>
                <form:form action="/register" method="post" modelAttribute="newUser">
                    ...
                    <form:input path="firstName" type="text" class="form-control mt-4 " id="floatingInput" placeholder="First name" />
                    <form:label path="firstName" for="floatingInput">first name</form:label>
					<form:errors path="firstName" class = "my-3" style="color:red;"/>
					</div>
					<div class="form-floating mb-3">
                    <form:input path="lastName" type="text" class="form-control mt-4 " id="floatingInput" placeholder="Last name" />
            ...
            <div class="col-md-4 me-5 border p-4 my-4 mb-0">
            <h3>Login</h3>
