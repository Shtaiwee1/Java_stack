	...
	public class BookController {
		...
		public String bookmarket(Model model, HttpSession session) {
			if (session.getAttribute("user_id") != null) {
				...
				List<Book> availableBooks = bookService.availableBooks();
				List<Book> borrowdBooksByLoggedUser = bookService.borrowedBooks((long) session.getAttribute("user_id"));
		...
		public String returnBook(@PathVariable("id") Long id, HttpSession session) {
			if (session.getAttribute("user_id") != null) {
				...
				bookService.returnBorrowedBook(id);
		...
		public String borrow(@PathVariable("id") Long id, HttpSession session) {
			if (session.getAttribute("user_id") != null) {
				...
				bookService.borrowBook(id, (long) session.getAttribute("user_id"));
