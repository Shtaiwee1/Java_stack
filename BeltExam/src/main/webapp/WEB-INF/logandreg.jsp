...
<body>
<div class="row mt-4">
<h1 style="text-align: center; color:#2c79e4">Course Platform - Instructors!</h1>
</div>
        ...
        <div class="row justify-content-center">
            ...
            <h3>New Instructor</h3>
                <form:form action="/register" method="post" modelAttribute="newUser">
                    ...
                    <form:input path="name" type="text" class="form-control mt-4 " id="floatingInput" placeholder="Last name" />
